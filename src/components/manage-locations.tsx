...
export function ManageLocations() {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <form onSubmit={handleAddLocation} className="flex flex-col sm:flex-row items-stretch sm:items-end gap-4">
          <div className="w-full space-y-2">
          ...
          <Button type="submit" disabled={isSaving || !newLocation.trim()} className="w-full sm:w-auto">
              ...
              {locations.map((loc) => (
                ...
                >
                  {editingLocation === loc ? (
                    ...
                    <>
                        <span className="text-sm font-medium break-all">{loc}</span>
